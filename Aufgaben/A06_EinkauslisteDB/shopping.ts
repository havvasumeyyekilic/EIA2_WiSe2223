/*
Aufgabe: Einkaufsliste (06)
Name: Havva Sümeyye Kilic
Matrikelnr: 271123
Datum: 19.11.2022
Quellen: Bastian Aberle, Lisa Blindenhöfer, Cindy Nguyen, Paula Jordans, Julia Befus, Aanya Khetarpal, Pia Giovannelli, letztes Semester ähnliche Aufgabe gemacht
*/
...
namespace shoppinglistA06 {
    ...
    async function handleload(): Promise<void> {
        ...
        let response: Response = await fetch("https://webuser.hs-furtwangen.de/~kilichav/Database/index.php/?command=find&collection=data");
    ...
    async function submitbutton(): Promise<void> {
        ...
        let response: Response = await fetch("https://webuser.hs-furtwangen.de/~kilichav/Database/index.php?" + query.toString());
