...
(function (shoppinglistA06) {
    ...
    async function handleload() {
        ...
        let response = await fetch("https://webuser.hs-furtwangen.de/~kilichav/Database/index.php/?command=find&collection=data");
    ...
    async function submitbutton() {
        ...
        let response = await fetch("https://webuser.hs-furtwangen.de/~kilichav/Database/index.php?" + query.toString());
