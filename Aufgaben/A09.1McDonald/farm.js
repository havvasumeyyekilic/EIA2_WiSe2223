...
(function (Farm) {
    ...
    function loadAnimals() {
        ...
        let dog = new Animal("Steve", "dog", "meat", "woof", 12);
        let cat = new Animal("Coco", "cat", "fish", "miauz", 5);
        let chicken = new Animal("Chicky", "chicken", "corn", "bock", 30);
        let pig = new Animal("Harami", "pig", "carrots", "quick", 25);
        animals.push(cow);
        animals.push(dog);
        animals.push(cat);
