...
namespace Farm {
    ...
    function loadAnimals(): void {
        ...
        let dog: Animal = new Animal("Steve", "dog", "meat", "woof", 12);
        let cat: Animal = new Animal("Coco", "cat", "fish", "miauz", 5);
        let chicken: Animal = new Animal("Chicky", "chicken", "corn", "bock", 30);
        let pig: Animal = new Animal("Harami", "pig", "carrots", "quick", 25);
